  ...
  >
    ...
    <ul class="hidden md:flex gap-items-menu">
      <li
        ...
        :key="route.key"
      >
        <a :class="colorText" data-astro-history="push" :href="to(route)">
          <span class="dot"
    ...
    <ul>
      <li v-if="contactRoute">
        <a :href="to(contactRoute)" data-astro-history="push" :class="[menuMobile ? '!text-black' : colorText, 'button-contact']">
          <span class="dot"
            :class="colorText === 'text-black' ? 'bg-black' : 'bg-white'"
          ></span>
